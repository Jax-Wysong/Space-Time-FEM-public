...
- `preconditiong/`: Contains code and testing for preconditioning schemes for wave, coupled nKG, Burgers, and linear advection equations. Mainly focused on a user-defined time-decomposition restricted additive Schwarz preconditioner.
